      ...
      <div className="container">
        ...
        <div className='pt-10'>
          ...
          <p className='font-medium text-base text-[#7E7E7E] pt-4'>Uninhibited carnally hired played in whimpered dear gorilla koala depending and much yikes off far quetzal goodness and from for grimaced
            ...
            <p className='font-medium text-base text-[#7E7E7E] pt-3'>mastodon goodness gnashed a jellyfish and one however because.Laconic overheard dear woodchuck wow this outrageously taut beaver hey hello far meadowlark imitatively egregiously hugged that yikes
